...
namespace core
{
    ...
    class tree
    {
        ...
        //////////////////////////////////////////////////////////////////////////
        tree()
        : data_(), next_(0), prev_(0), in_(0), out_(0), level_(0), size_(0)
        {
        }
        ...
        //////////////////////////////////////////////////////////////////////////
        tree(const T &inT)
        : data_(inT), next_(0), prev_(0), in_(0), out_(0), level_(0), size_(0)
        {
        }
        ...
        //////////////////////////////////////////////////////////////////////////
        tree(const tree &in)
        : data_(in.data_), next_(0), prev_(0), in_(0), out_(0),
          level_(0), size_(0)
        {
            *this = in;
        }
    ...
    class tree_iterator : private tree<T>
    {
        ...
        {
            this->current_ = (const_cast<TreeType *>(this->TreeType::next(*current_)));
            return (*this);
        }
        ...
        const typename tree<T>::iterator &operator--() const
        {
            this->current_ = (const_cast<TreeType *>(this->TreeType::prev(*current_)));
            return (*this);
        }
        ...
        typename tree<T>::iterator find(const T &inT, const typename tree<T>::iterator &iter, bool (*obj)(const T &, const T &)) const
        {
        ...
        typename tree<T>::iterator tree_find_depth(const T &inT, const typename tree<T>::iterator &iter, bool (*obj)(const T &, const T &)) const
        {
        ...
        typename tree<T>::iterator tree_find_breadth(const T &inT, const typename tree<T>::iterator &iter, bool (*obj)(const T &, const T &)) const
        {
