...
#undef CEREAL_RAPIDJSON_STRING_
        ...
        {
            Property()
            : schema(), dependenciesSchema(), dependenciesValidatorIndex(), dependencies(), required(false)
            {
            }
            ~Property()
            {
...
class GenericSchemaDocument
{
    ...
    */
    ...
    GenericSchemaDocument(GenericSchemaDocument &&rhs) CEREAL_RAPIDJSON_NOEXCEPT : remoteProvider_(rhs.remoteProvider_),
...
#define CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(method, arg1, arg2) \
    ...
    bool Null()
    {
        CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(Null, (CurrentContext()), ());
    }
    bool Bool(bool b)
    {
        CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(Bool, (CurrentContext(), b), (b));
    }
    bool Int(int i)
    {
        CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(Int, (CurrentContext(), i), (i));
    }
    bool Uint(unsigned u)
    {
        CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(Uint, (CurrentContext(), u), (u));
    }
    bool Int64(int64_t i)
    {
        CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(Int64, (CurrentContext(), i), (i));
    }
    bool Uint64(uint64_t u)
    {
        CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(Uint64, (CurrentContext(), u), (u));
    }
    bool Double(double d)
    {
        CEREAL_RAPIDJSON_SCHEMA_HANDLE_VALUE_(Double, (CurrentContext(), d), (d));
    }
