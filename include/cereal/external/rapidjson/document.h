...
class GenericValue
{
    ...
    GenericValue() CEREAL_RAPIDJSON_NOEXCEPT : data_()
    {
...
/*! \param b Boolean value
    ...
    explicit GenericValue(double d) CEREAL_RAPIDJSON_NOEXCEPT : data_()
    {
        data_.n.d = d;
    ...
    GenericValue(const Ch *s, SizeType length) CEREAL_RAPIDJSON_NOEXCEPT : data_()
    {
        SetStringRaw(StringRef(s, length));
    }

    //! Constructor for constant string (i.e. do not make a copy of string)
    explicit GenericValue(StringRefType s) CEREAL_RAPIDJSON_NOEXCEPT : data_()
    {
        SetStringRaw(s);
    }
    ...
    */
    ...
    /*!
        ...
        \see Swap()
     */
    friend inline void swap(GenericValue &a, GenericValue &b) CEREAL_RAPIDJSON_NOEXCEPT
    {
        a.Swap(b);
    }
    ...
    /*! \return *this */
    GenericValue &Move() CEREAL_RAPIDJSON_NOEXCEPT
    {
        return *this;
    }
    //@}
    ...
    */
    template<typename T>
    CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>, internal::IsGenericValue<T>>), (bool))
     ...
     */
    template<typename T>
    CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::IsGenericValue<T>), (bool))
    operator!=(const T &rhs) const
    {
        return !(*this == rhs);
    }
     ...
     */
    template<typename T>
    friend CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::IsGenericValue<T>), (bool)) operator==(const T &lhs, const GenericValue &rhs)
    {
        return rhs == lhs;
    }
    ...
    bool GetBool() const
    {
        CEREAL_RAPIDJSON_ASSERT(IsBool());
        return data_.f.flags == kTrueFlag;
    }
    //!< Set boolean value
    /*! \post IsBool() == true */
    ...
    */
    template<typename T>
    CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::NotExpr<internal::IsSame<typename internal::RemoveConst<T>::Type, Ch>>), (GenericValue &))
    operator[](T *name)
    {
    ...
    template<typename T>
    CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::NotExpr<internal::IsSame<typename internal::RemoveConst<T>::Type, Ch>>), (const GenericValue &))
    ...
    */
    ...
    int GetInt() const
    {
        CEREAL_RAPIDJSON_ASSERT(data_.f.flags & kIntFlag);
        return data_.n.i.i;
    }
    unsigned GetUint() const
    {
        CEREAL_RAPIDJSON_ASSERT(data_.f.flags & kUintFlag);
        return data_.n.u.u;
    }
    int64_t GetInt64() const
    {
        CEREAL_RAPIDJSON_ASSERT(data_.f.flags & kInt64Flag);
        return data_.n.i64;
    }
    uint64_t GetUint64() const
    {
        CEREAL_RAPIDJSON_ASSERT(data_.f.flags & kUint64Flag);
        return data_.n.u64;
    }
    ...
    */
    double GetDouble() const
    {
        ...
        CEREAL_RAPIDJSON_ASSERT((data_.f.flags & kUint64Flag) != 0);
    ...
    */
    ...
    {
        return CEREAL_RAPIDJSON_GETPOINTER(Ch, data_.s.str);
    }
    CEREAL_RAPIDJSON_FORCEINLINE const Ch *SetStringPointer(const Ch *str)
    {
        return CEREAL_RAPIDJSON_SETPOINTER(Ch, data_.s.str, str);
    }
    ...
    {
        return CEREAL_RAPIDJSON_SETPOINTER(GenericValue, data_.a.elements, elements);
    }
    CEREAL_RAPIDJSON_FORCEINLINE Member *GetMembersPointer() const
    {
        return CEREAL_RAPIDJSON_GETPOINTER(Member, data_.o.members);
    }
    CEREAL_RAPIDJSON_FORCEINLINE Member *SetMembersPointer(Member *members)
    {
        return CEREAL_RAPIDJSON_SETPOINTER(Member, data_.o.members, members);
    }
...
class GenericDocument : public GenericValue<Encoding, Allocator>
{
    ...
    */
    ...
    /*!
        ...
        \see Swap()
     */
    friend inline void swap(GenericDocument &a, GenericDocument &b) CEREAL_RAPIDJSON_NOEXCEPT
    {
        a.Swap(b);
    }
...
template<typename Encoding, typename Allocator>
template<typename SourceAllocator>
inline GenericValue<Encoding, Allocator>::GenericValue(const GenericValue<Encoding, SourceAllocator> &rhs, Allocator &allocator)
{
    switch (rhs.GetType())
    {
        case kObjectType:
...
class GenericArray
{
    ...
    template<typename T>
    CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>, internal::IsGenericValue<T>>), (const GenericArray &))
...
class GenericObject
{
    ...
    template<typename T>
    CEREAL_RAPIDJSON_DISABLEIF_RETURN((internal::OrExpr<internal::IsPointer<T>, internal::IsGenericValue<T>>), (GenericObject))
