...
#define CEREAL_RAPIDJSON_NAMESPACE_BEGIN \
    namespace CEREAL_RAPIDJSON_NAMESPACE \
    {
#endif
...
*/
#if defined(CEREAL_RAPIDJSON_SSE2) || defined(CEREAL_RAPIDJSON_SSE42) || defined(CEREAL_RAPIDJSON_DOXYGEN_RUNNING)
...
#define CEREAL_RAPIDJSON_MULTILINEMACRO_BEGIN \
    do                                        \
    {
...
#define CEREAL_RAPIDJSON_DIAG_OFF(x) CEREAL_RAPIDJSON_DIAG_PRAGMA(disable \
                                                                  : x)
#define CEREAL_RAPIDJSON_DIAG_PUSH CEREAL_RAPIDJSON_DIAG_PRAGMA(push)
#define CEREAL_RAPIDJSON_DIAG_POP CEREAL_RAPIDJSON_DIAG_PRAGMA(pop)
